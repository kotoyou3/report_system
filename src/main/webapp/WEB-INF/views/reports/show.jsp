    ...
    <c:param name="content">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th>内容</th>
                    <td><pre><c:out value="${report.content.trim()}" /></pre></td>
                </tr>
                <tr>
                    <th>登録日時</th>
        ...
        <!-- 編集ボタンは自分の日報、または管理者の場合に表示 -->
        <c:if test="${sessionScope.login_employee.id == report.employee.id or sessionScope.login_employee.adminFlag == 1}">
